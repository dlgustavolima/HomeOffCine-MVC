...
public class SeleniumHelper : IDisposable
{
    ...
    public SeleniumHelper(string browser, ConfigurationHelper configuration, bool headless = false)
    {
        Configuration = configuration;
        WebDriver = WebDriverFactory.CreateWebDriver("Chrome", Configuration.WebDrivers, headless);
    ...
    {
        screenshot.SaveAsFile($"{Configuration.FolderPicture}{fileName}.png");
    }
